    ...
    <TooltipRoot>
      <TooltipTrigger as-child>
        <button
          ...
          class="flex min-h-[36px] items-center gap-1.5 rounded-md border border-surface-300 px-2 py-1.5 text-xs font-medium text-surface-700 transition-colors hover:bg-surface-100 active:bg-surface-200 dark:border-surface-600 dark:text-surface-300 dark:hover:bg-surface-800"
          @click="copyAddress"
        >
